...
export const LAKES: Lake[] = [
  ...
  { id: 'lyndon-b-johnson', name: 'LAKE LBJ',           location: 'LLANO COUNTY, TX',  fullPool: 824.0,  lowThreshold: 790.0 },
  ...
  { id: 'austin',           name: 'LAKE AUSTIN',        location: 'AUSTIN, TX',         fullPool: 492.0,  lowThreshold: 460.0 },
]
